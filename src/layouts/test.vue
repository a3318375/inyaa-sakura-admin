...
import { colors, copyToClipboard, morph } from 'quasar'
    ...
    >
      <q-toolbar class="GNL__toolbar">
        <q-btn
          ...
          @click="onClick"
        />
        <q-btn v-show="$q.screen.gt.xs" dense flat size="sm" class="q-mr-xs">
          <q-avatar size="sm">
            <q-img src="imgs/logo/sika-logo.png" />
          </q-avatar>
        </q-btn>
        <q-space />
        <div v-if="$q.screen.gt.sm" class="q-gutter-xs">
          <q-btn
            type="a" target="_blank" unelevated size="sm" dense round
        ...
        <div class="q-gutter-xs q-ml-sm row items-center no-wrap">
          ...
          <span class="inline-block">
            <q-chip dense color="white" class="cursor-pointer q-ml-sm">
              ...
              >
                <q-list dense>
                  <q-item v-close-popup clickable to="/account/center">
                    <q-item-section
                      avatar
                  ...
                  <q-item v-close-popup clickable to="/account/settings">
                    <q-item-section
                      avatar
                      class="q-mr-sm q-pa-none"
                      style="min-width: 0"
                  ...
                  <q-item v-close-popup clickable to="/user/login">
                    <q-item-section
                      avatar
                      class="q-mr-sm q-pa-none"
                      style="min-width: 0"
    ...
    >
      <div class="q-my-lg">
        <div class="text-center q-mb-sm">
          ...
          <q-btn
            type="a" target="_blank" unelevated size="12px" dense round
            href="http://www.quasarchs.com/"
          >
            <q-avatar size="sm">
              <img alt="quasar" src="https://cdn.quasar.dev/logo/svg/quasar-logo.svg">
        ...
        <div class="text-center">
          {{ `Copyright@2020 Sika ${$t('StandardLayout.experienceTheTechnicalDepartment')}` }}
        </div>
      </div>
    </q-footer>
    <q-drawer
      ...
      >
        <div class="q-pa-sm">
          <q-list padding>
            ...
            <q-separator spaced="“12px" />
            <q-item-label header>
              {{ $t('StandardLayout.otherSettings') }}
            </q-item-label>
            ...
            <q-item tag="label">
              ...
              <q-item-section side top>
                <q-toggle v-model="notif2" color="primary" val="friend" />
              </q-item-section>
            </q-item>
            <q-separator spaced="“12px" />
            <q-item>
